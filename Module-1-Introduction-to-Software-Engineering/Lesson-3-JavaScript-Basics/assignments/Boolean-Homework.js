...
const numOfWM = Math.ceil(Math.random()*20)

console.log(numOfWM)

if(numOfWM == 1 || numOfWM == 2){
    console.log('Looks like you like watermelons!')
}
else if(numOfWM > 2 && numOfWM <= 5){
    ...
    console.log('You must be CRAZY for watermelons!')
}
else{
...
const hungerLvl = Math.ceil(Math.random()*10)

const howHungry = hungerLvl > 6 ? 'Time to eat!' : 'I\'m not hungry!'

console.log(`Hunger Level: ${hungerLvl} | ${howHungry}`)
...
switch(randomNum){
    case 1:
        ...
        break;
    case 2:
        console.log("You get pizza!")
        break;
    case 3:
        console.log("You get apples!")
        break;
    case 4:
        console.log("You get Tamashii Ramen!")
        break;
    case 5:
        console.log("You get a burrito!")
        break;
    case 6:
        console.log("You get a MegaDrive console!")
        break;
    case 7:
        console.log("You get a Pomni Plushie!")
        break;
    case 8:
        console.log("You get a book on C\+\+!")
        break;
    default:
        console.log("Sorry, try again! You might get something this time!")
}